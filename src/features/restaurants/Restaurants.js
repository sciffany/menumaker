...
import { addRestaurantBackend, getRestaurantsBackend } from "./restaurantService";
import { selectToken } from "../login/loginSlice";
import OneRestaurant from "./Restaurant";
...
function Restaurants() {
  ...
  const [wasNewRestaurantCreated, setWasNewRestaurantCreated] = React.useState(false);
